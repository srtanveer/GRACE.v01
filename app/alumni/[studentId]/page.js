...
const alumniMap = {
  '22190200123': {
    ...
    name: 'Nusrat Jahan',
    profileImage: '/images/alumni/placeholder-1.jpg',
    batch: 'CSE 221',
    graduationYear: 2026,
    ...
    shortBio: 'Product-minded software engineer passionate about impactful digital experiences and community growth.',
    biography:
      'Nusrat is a software engineer with a strong interest in building thoughtful product experiences and supporting the next generation of developers. Her work combines product thinking, engineering discipline, and a focus on real-world user value.',
    education: [
      { institution: 'Green University of Bangladesh', degree: 'B.Sc. in Computer Science and Engineering', year: '2026' },
    ],
    career: [
      { organization: 'Pathao', designation: 'Senior Product Engineer', startYear: 2026, endYear: null },
    ],
    skills: ['React', 'JavaScript', 'Product Strategy', 'UX Thinking'],
    achievements: ['Built product features used by thousands of users', 'Mentored junior graduates through community initiatives'],
    projects: [
      { title: 'Campus to Career Platform', description: 'A platform to connect students with mentors and internship opportunities.' },
    ],
    graceInvolvement: 'Active in GRACE mentorship activities and alumni networking programs.',
  ...
  '20190203456': {
    ...
    name: 'Mahmud Hasan',
    profileImage: '/images/alumni/placeholder-2.jpg',
    batch: 'CSE 201',
    graduationYear: 2024,
    ...
    location: 'Dhaka, Bangladesh',
    shortBio: 'Engineering leader focused on scalable systems, product reliability, and team growth.',
    biography:
      'Mahmud has worked across engineering teams and product environments, helping teams deliver well-structured digital products with a focus on maintainability and impact.',
    education: [
      { institution: 'Green University of Bangladesh', degree: 'B.Sc. in Computer Science and Engineering', year: '2024' },
    ],
    career: [
      { organization: 'Brain Station 23', designation: 'Lead Software Developer', startYear: 2024, endYear: null },
    ],
    skills: ['Node.js', 'System Design', 'Leadership', 'JavaScript'],
    achievements: ['Led critical platform improvements', 'Supported student mentorship and community engagement'],
    projects: [{ title: 'Scalable API Platform', description: 'Improved internal service stability and developer velocity.' }],
    graceInvolvement: 'Participated in networking and community events organized by GRACE.',
    social: { linkedin: '#', github: '#', website: '#' },
    featured: false,
  },
  '20180201987': {
    ...
    shortBio: 'Data scientist focused on turning complex information into useful decisions and measurable impact.',
    biography: 'Rabeya works at the intersection of analytics, technology, and business problem-solving. She is also committed to helping students understand the opportunities available in data and emerging technology careers.',
    education: [{ institution: 'Green University of Bangladesh', degree: 'B.Sc. in Computer Science and Engineering', year: '2023' }],
    career: [{ organization: 'Airtel Digital', designation: 'Senior Data Scientist', startYear: 2023, endYear: null }],
    skills: ['Python', 'Data Analysis', 'Machine Learning', 'SQL'],
    achievements: ['Delivered data-driven insights for business teams', 'Contributed to alumni and student career conversations'],
    graceInvolvement: 'Supports GRACE knowledge-sharing and professional networking activities.',
    social: {},
    featured: true,
  },
  '19180201344': {
    ...
    shortBio: 'Research engineer interested in open technology, experimentation, and practical innovation.',
    biography: 'Sabbir combines software engineering with applied research to explore useful tools and ideas. His work reflects the value of curiosity, collaboration, and continuous learning after graduation.',
    education: [{ institution: 'Green University of Bangladesh', degree: 'B.Sc. in Computer Science and Engineering', year: '2022' }],
    career: [{ organization: 'Open Source Lab', designation: 'Research Engineer', startYear: 2022, endYear: null }],
    skills: ['Research', 'JavaScript', 'Open Source', 'System Design'],
    achievements: ['Contributed to open-source research initiatives', 'Built experimental tools for technical teams'],
    graceInvolvement: 'Engages with GRACE through technical discussions and alumni collaboration.',
    social: {},
    featured: false,
  },
  '151002017': {
