...
export default function Footer() {
  return (
    <footer className="border-t border-[rgba(17,33,61,0.08)] bg-white">
      <div className="mx-auto grid max-w-7xl grid-cols-3 gap-x-4 gap-y-8 px-6 py-10 lg:grid-cols-[1.3fr_0.7fr_0.7fr_0.9fr] lg:gap-8 lg:px-10">
        <div className="col-span-3 lg:col-span-1">
          ...
          <p className="mt-4 max-w-sm !text-left text-sm text-foreground/70">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-xs text-foreground/70 sm:text-sm">
        ...
        <div>
          ...
          <div className="mt-4 space-y-2 text-xs text-foreground/70 sm:text-sm">
